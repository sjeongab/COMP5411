...
const objects = [
    {type: 'plane', color: new THREE.Color(0xaaaaaa), reflectivity: 0.8},
    { type: 'cube', position: [-40.0, 5.1, 15.0], scale: 10, rotationSpeed: 0, color: new THREE.Color(0XF0DD98), reflectivity: 1.0 },
    ...
    { type: 'sphere', position: [-20, 9.5, 40.0], scale: 9.0, rotationSpeed: -1.0, color: new THREE.Color(0xB1C193), reflectivity: 0.5 },
    { type: 'cube', position: [35, 9.5, 40.0], scale: 18, rotationSpeed: 0, color: new THREE.Color(0xA5CCD6), reflectivity: 0.5},
    // Additional shapes
    { type: 'sphere', position: [15.0, 10, 25], scale: 10, rotationSpeed: 0.9, color: new THREE.Color(0xDF9D97), reflectivity: 1.0 },
    { type: 'cube', position: [70, 9.5, 25], scale: 14, rotationSpeed: 0, color: new THREE.Color(0xA3C0D3), reflectivity: 1.0 },
