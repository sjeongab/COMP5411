...
const objects = [
    {type: 'plane', color: new THREE.Color(0xaaaaaa), reflectivity: 0.8, specular: new THREE.Color(0x888888), shininess: 0.0},
    { type: 'cube', position: [-40.0, 5.1, 15.0], scale: 10, rotationSpeed: 0, color: new THREE.Color(0XF0DD98), reflectivity: 1.0, specular: new THREE.Color(0x888888), shininess: 10.0},
    { type: 'sphere', position: [0, 20, 0], scale: 20, rotationSpeed: 0.8, color: new THREE.Color(0XE7C88D), reflectivity: 1.0, specular: new THREE.Color(0xB4955A), shininess: 1.3 },
    { type: 'sphere', position: [-35.0, 8, -20.0], scale: 8, rotationSpeed: 1.2, color: new THREE.Color(0xE7577F7), reflectivity: 0.5, specular: new THREE.Color(0xB4244C4), shininess: 0.0},
    { type: 'sphere', position: [-20, 9.5, 40.0], scale: 9.0, rotationSpeed: -1.0, color: new THREE.Color(0xB1C193), reflectivity: 0.5, specular: new THREE.Color(0x888888), shininess: 10.0 },
    { type: 'cube', position: [35, 9.5, 40.0], scale: 18, rotationSpeed: 0, color: new THREE.Color(0xA5CCD6), reflectivity: 0.5, specular: new THREE.Color(0x7299A3), shininess: 3.0},
    // Additional shapes
...
function addPlainObjects(scene) {
  objects.forEach((object) => {
    if (object.type === 'plane') {
      ...
      const planeMaterial = new THREE.MeshPhongMaterial({ color: 0xaaaaaa, side: THREE.DoubleSide, specular: object.specular, shininess: object.shininess  });
