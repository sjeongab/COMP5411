...
const objects = [
    ...
    { type: 'sphere', position: [-20, 9.5, 40.0], scale: 9.0, rotationSpeed: -1.0, color: new THREE.Color(0xB1C193), reflectivity: 0.5, specular: new THREE.Color(0x888888), shininess: 30 },
    { type: 'cube', position: [35, 9.5, 40.0], scale: 18, rotationSpeed: 0, color: new THREE.Color(0xA5CCD6), reflectivity: 0.5, specular: new THREE.Color(0x7299A3), shininess: 70},
    // Additional shapes
    { type: 'sphere', position: [15.0, 10, 25], scale: 10, rotationSpeed: 0.9, color: new THREE.Color(0xDF9D97), reflectivity: 1.0, specular: new THREE.Color(0x888888), shininess: 0 },
    { type: 'cube', position: [70, 9.5, 25], scale: 14, rotationSpeed: 0, color: new THREE.Color(0xA3C0D3), reflectivity: 1.0, specular: new THREE.Color(0xffffff), shininess: 100, },
    { type: 'sphere', position: [-55, 5, 45], scale: 5, rotationSpeed: 1.5, color: new THREE.Color(0xABD0C4), reflectivity: 1.0, specular: new THREE.Color(0x78A091), shininess: 80,},
