...
import {ssrAveragedVertexShader} from './ssrAveragedVertexShader.js';
import {ssrAveragedFragmentShader} from './ssrAveragedFragmentShader.js';
import {gBuffer} from '../gBuffer/gBuffer.js';

/* ---------------- SSR Averaged material ---------------- */
function loadSSRAveragedMaterial(ssrCamera) {
    const ssrAveragedMaterial = new THREE.ShaderMaterial({
    vertexShader: ssrAveragedVertexShader,
    fragmentShader: ssrAveragedFragmentShader,
    ...
    return ssrAveragedMaterial;
}

export {loadSSRAveragedMaterial};